...
<body>
    ...
    <!-- Navbar Start -->
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s" style="background-color: #ffffff7c";>
        <div class="top-bar row gx-0 align-items-center d-none d-lg-flex">
            ...
            <div class="col-lg-6 px-5 text-end">
                <small><i class="fa fa-envelope me-2" style="color:rgb(255, 0, 0);"></i><a
                        href="mailto:eversyslanka@gmail.com" class="text-dark">eversyslanka@gmail.com</a></small>

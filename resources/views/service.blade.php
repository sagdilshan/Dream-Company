                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-4">Unlock the full potential of online commerce with our comprehensive
                                        e-commerce solutions. We design and develop user-friendly, secure, and scalable
                                        online stores that drive business growth.</p>
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-4">Harness the power of bespoke software solutions. Our custom
                                        development services cater to your specific requirements, ensuring efficiency,
                                ...
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100"
                                            src="../assets/img/service-4.jpg" style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h3 class="mb-4">Maintenance and Support</h3>
                                    <p class="mb-4">Ensure the longevity of your digital assets with our reliable
                                        maintenance and support services. We provide updates, and optimizations to keep your

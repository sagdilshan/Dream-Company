...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Eversys Technology - Innovation for Every Journey')
@section('content')
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    <p class="fs-5 fw-medium" style="color:rgb(255, 0, 0);">Welcome to Eversys Technology</p>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="fs-5 fw-medium text-danger">Why Choosing Eversys Technology</p>
                    <h1 class="display-5 mb-4">Few Reasons Why People Choosing Us</h1>
                    <p class="mb-4">Discover the difference with Eversys Technology. Here are just a few reasons why people trust and choose us</p>
                    ...
                    <div class="row g-4 align-items-center">
                            ...
                            <div class="row g-4">
                                <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                                    <div class="feature-box border rounded p-4">
                                        ...
                                        <p class="mb-3">At Eversys Technology, we lead in innovation, shaping the future
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.5s">
                                    <div class="feature-box border rounded p-4">
                                        ...
                                        <p class="mb-3">Experience peace of mind with Eversys Technology – Support and Maintenance for sustained success and worry-free digital solutions.
                                        </p>
                                        <a class="fw-semi-bold text-danger">Read More <i
                                                class="fa fa-arrow-right ms-1"></i></a>
                                    </div>
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.7s">
                            <div class="feature-box border rounded p-4">
                                ...
                                <p class="mb-3">At Eversys Technology, your needs are at the heart of what we do – a
        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">At Eversys Technology, we are more than a web development company – we are architects
                    ...
                    <div class="border rounded p-4">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-mission" role="tabpanel"
                                ...
                                <p class="mb-0">Our mission at Eversys Technology aims to deliver exceptional technology
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-5 mb-5">Awesome Services For You & Your Business</h1>
            </div>

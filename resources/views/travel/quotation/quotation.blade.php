                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row mt-3">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="datetime-local" class="form-control" name="contact"
                                                                    placeholder="Select model">
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group row mt-3">
                                                            <label class="col-sm-4 col-form-label"
                                                                style="font-weight: 600;">A/C Cost</label>
                                                            <div class="col-sm-8">
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row mt-3">
                                                            <label class="col-sm-4 col-form-label"
                                                                style="font-weight: 600;">Night Charges
                                                            </label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control"
                                                                    name="service_cost" value="0" required readonly

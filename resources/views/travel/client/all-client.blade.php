...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Travel Customers')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <h2 style="font-family: Open Sans;">Travel Customers</h2>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="active tab-pane" id="settings">
                                        <form method="post" action="{{ route('travel.client.store') }}">
                                            @csrf
                                            ...
                                            <div class="form-group row mt-3">
                                                <label class="col-sm-2 col-form-label" style="font-weight: 600;">Passport Number</label>
                                                <div class="col-sm-10">
